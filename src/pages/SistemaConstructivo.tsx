...
const systems: ConstructionSystem[] = [
  {
    ...
    description: "Panel estructural aislante compuesto por un núcleo de espuma rígida de poliuretano (PUR) de celda cerrada entre dos tableros OSB, formando un módulo simultáneamente portante y aislante. Fabricado a medida en fábrica según diseño CAD/CAM 3D, cada panel llega cortado, numerado y listo para ensamblar como piezas de LEGO. Los conectores entre paneles se rellenan con espuma PUR, eliminando puentes térmicos y garantizando estanqueidad total al aire y al vapor durante toda la vida útil.",
    features: [
      "Módulo portante + aislante: muros, cubiertas, forjados y suelos en un solo elemento",
      "Espuma PUR de celda cerrada: no absorbe humedad, no asienta, no pierde propiedades",
      "Capacidad de carga en muros hasta 4 plantas (rotura a 440 kN/m en panel de 100 mm)",
      "Cubiertas autoportantes sin cerchas o con estructura mínima de pares",
      "Espesor de pared un 50% menor que con lana mineral o EPS para el mismo valor U",
      "Montaje 2× más rápido que entramado de madera (casa 110 m² en pocos días)",
      "Fabricación en nave: calidad constante e independiente del clima",
      "Resistente a insectos, roedores, moho, productos químicos y hasta 230 °C",
      "Flexibilidad de diseño: compatible con cualquier acabado de fachada y cubierta",
      "Valores U desde 0.10 W/m²K con espesores reducidos"
    ],
    houseImage: casaSip,
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-4 left-4 bg-background/90 backdrop-blur-sm rounded-xl px-4 py-2 border border-orange/20">
                  <span className="text-sm font-semibold text-orange">Sección técnica MA'S ETC</span>
                </div>
              </div>
            </div>
          </motion.div>
